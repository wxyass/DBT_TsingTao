 ...
 */
@DatabaseTable(tableName = "MIT_VISITMEMO_INFO")
public class MitVisitmemoInfo implements java.io.Serializable {
	...
	/** default constructor */
	public MitVisitmemoInfo() {
	}

	/** minimal constructor */
	public MitVisitmemoInfo(String memokey) {
		this.memokey = memokey;
	}

	/** full constructor */
	public MitVisitmemoInfo(String memokey, String terminalkey, String content, String isover, String iswarn, String startdate, String enddate, String sisconsistent, Date scondate, String padisconsistent, Date padcondate, String comid, String remarks, String orderbyno, String deleteflag, Integer version, Date credate, String creuser, Date updatetime, String updateuser) {
		this.memokey = memokey;
