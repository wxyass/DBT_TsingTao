...
import dd.tsingtaopad.db.dao.impl.MitValcmpMTempDaoImpl;
 ...
 */
@DatabaseTable(tableName = "MIT_VALCMP_M_TEMP", daoClass = MitValcmpMTempDaoImpl.class)
public class MitValcmpMTemp implements java.io.Serializable {
