...
import dd.tsingtaopad.db.dao.impl.MitCameraInfoMDaoImpl;


/**
 * 图片表 临时表
 * MstCameraInfoMTemp entity. @author MyEclipse Persistence Tools
 */
@DatabaseTable(tableName = "MIT_CAMERAINFO_M", daoClass = MitCameraInfoMDaoImpl.class)
public class MitCameraInfoM implements java.io.Serializable {
	...
	/** default constructor */
	public MitCameraInfoM() {
	}

	/** minimal constructor */
	public MitCameraInfoM(String camerakey) {
	 ...
	 * @param picindex
	 */
	public MitCameraInfoM(String camerakey, String terminalkey, String picname,
