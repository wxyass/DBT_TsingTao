...
import dd.tsingtaopad.db.dao.impl.MitValagreeMTempDaoImpl;
 ...
 */
@DatabaseTable(tableName = "MIT_VALAGREE_M_TEMP", daoClass = MitValagreeMTempDaoImpl.class)
public class MitValagreeMTemp implements java.io.Serializable {
