...
import dd.tsingtaopad.db.dao.impl.MitVisitMDaoImpl;
 ...
 */
//MST_VISIT_M(拜访主表)
@DatabaseTable(tableName = "MIT_VISIT_M", daoClass = MitVisitMDaoImpl.class)
public class MitVisitM implements java.io.Serializable {
	...
	/** minimal constructor */
	public MitVisitM(String visitkey) {
		this.visitkey = visitkey;
	}

	/** full constructor */
	public MitVisitM(String visitkey, String terminalkey, String routekey, String gridkey, String areaid, String visitdate, String enddate, String tempkey, String userid, String visituser,
