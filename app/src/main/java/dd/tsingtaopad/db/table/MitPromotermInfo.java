 ...
 */
@DatabaseTable(tableName = "MIT_PROMOTERM_INFO")
public class MitPromotermInfo implements java.io.Serializable {
	...
	/** default constructor */
	public MitPromotermInfo() {
	}

	/** minimal constructor */
	public MitPromotermInfo(String recordkey) {
		this.recordkey = recordkey;
	}

	/** full constructor */
	public MitPromotermInfo(String recordkey, String ptypekey, String terminalkey, String visitkey, String startdate, String isaccomplish,
