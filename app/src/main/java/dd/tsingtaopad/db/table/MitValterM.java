...
import dd.tsingtaopad.db.dao.impl.MitValterMDaoImpl;
 ...
 */
//MIT_VALTER_M(追溯主表)
@DatabaseTable(tableName = "MIT_VALTER_M", daoClass = MitValterMDaoImpl.class)
public class MitValterM implements java.io.Serializable {
