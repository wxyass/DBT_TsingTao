...
public class AlertKeyValueAdapter extends BaseAdapter {
     ...
     */
    public AlertKeyValueAdapter(Context context, List dataLst, String fieldName[], String selectedId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_alert_list, null);
