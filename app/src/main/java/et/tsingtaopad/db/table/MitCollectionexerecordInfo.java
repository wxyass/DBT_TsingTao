...
@DatabaseTable(tableName = "MIT_COLLECTIONEXERECORD_INFO")
public class MitCollectionexerecordInfo implements java.io.Serializable {
	...
	/** default constructor */
	public MitCollectionexerecordInfo() {
	}

	/** minimal constructor */
	public MitCollectionexerecordInfo(String colrecordkey) {
