...
import et.tsingtaopad.db.dao.impl.MitTerminalinfoMDaoImpl;
import et.tsingtaopad.db.dao.impl.MstTerminalinfoMTempDaoImpl;
 ...
 * 终端信息临时表
 */
@DatabaseTable(tableName = "MIT_TERMINALINFO_M", daoClass = MitTerminalinfoMDaoImpl.class)
public class MitTerminalinfoM implements java.io.Serializable {
	...
	/** default constructor */
	public MitTerminalinfoM() {
	}

	/** minimal constructor */
	public MitTerminalinfoM(String terminalkey) {
		this.terminalkey = terminalkey;
	}

	/** full constructor */
	public MitTerminalinfoM(String terminalkey, String routekey, String terminalcode, String terminalname, String province, String city,
