 ...
 * 竞品供货关系 临时表
 */
@DatabaseTable(tableName = "MIT_CMPSUPPLY_INFO")
public class MitCmpsupplyInfo implements java.io.Serializable {
    ...
    /** default constructor */
    public MitCmpsupplyInfo() {
    }

    /** minimal constructor */
    public MitCmpsupplyInfo(String cmpsupplykey) {
        this.cmpsupplykey = cmpsupplykey;
    }

    /** full constructor */
    public MitCmpsupplyInfo(String cmpsupplykey, String cmpproductkey,
