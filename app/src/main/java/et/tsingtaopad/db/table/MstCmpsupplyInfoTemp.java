...
/**
 * MstCmpsupplyInfoTemp entity. @author MyEclipse Persistence Tools
 * 竞品供货关系 临时表
 */
@DatabaseTable(tableName = "MST_CMPSUPPLY_INFO_TEMP")
public class MstCmpsupplyInfoTemp implements java.io.Serializable {
    ...
    /** default constructor */
    public MstCmpsupplyInfoTemp() {
    }

    /** minimal constructor */
    public MstCmpsupplyInfoTemp(String cmpsupplykey) {
        this.cmpsupplykey = cmpsupplykey;
    }

    /** full constructor */
    public MstCmpsupplyInfoTemp(String cmpsupplykey, String cmpproductkey,
