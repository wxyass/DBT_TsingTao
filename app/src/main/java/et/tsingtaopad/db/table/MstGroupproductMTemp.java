...
import et.tsingtaopad.db.dao.impl.MstGroupproductMTempDaoImpl;
...
@DatabaseTable(tableName = "MST_GROUPPRODUCT_M_TEMP", daoClass = MstGroupproductMTempDaoImpl.class)
public class MstGroupproductMTemp implements java.io.Serializable {
	...
	/** default constructor */
	public MstGroupproductMTemp() {
	}

	/** minimal constructor */
	public MstGroupproductMTemp(String gproductid) {
	 ...
	 */
	public MstGroupproductMTemp(String gproductid, String terminalcode, String terminalname, String ifrecstand, String startdate, String enddate, String createusereng, String createdate, String updateusereng, String updatetime, String uploadFlag, String padisconsistent) {
		super();
		this.gproductid = gproductid;
