...
/**
 * MstVisitmemoInfoTemp entity. @author MyEclipse Persistence Tools
 */
@DatabaseTable(tableName = "MST_VISITMEMO_INFO_TEMP")
public class MstVisitmemoInfoTemp implements java.io.Serializable {
	...
	/** default constructor */
	public MstVisitmemoInfoTemp() {
	}

	/** minimal constructor */
	public MstVisitmemoInfoTemp(String memokey) {
		this.memokey = memokey;
	}

	/** full constructor */
	public MstVisitmemoInfoTemp(String memokey, String terminalkey, String content, String isover, String iswarn, String startdate, String enddate, String sisconsistent, Date scondate, String padisconsistent, Date padcondate, String comid, String remarks, String orderbyno, String deleteflag, Integer version, Date credate, String creuser, Date updatetime, String updateuser) {
		this.memokey = memokey;
