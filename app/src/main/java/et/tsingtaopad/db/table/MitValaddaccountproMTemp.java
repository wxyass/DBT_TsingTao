...
import et.tsingtaopad.db.dao.impl.MitValaddaccountproMTempDaoImpl;
 ...
 */
@DatabaseTable(tableName = "MIT_VALADDACCOUNTPRO_M_TEMP", daoClass = MitValaddaccountproMTempDaoImpl.class)
public class MitValaddaccountproMTemp implements java.io.Serializable {
    // Fields
     ...
     * default constructor
     */
    public MitValaddaccountproMTemp() {
    }
