 ...
 */
@DatabaseTable(tableName = "MST_CHECKEXERECORD_INFO", daoClass=MstCheckexerecordInfoDaoImpl.class)
public class MstCheckexerecordInfo implements java.io.Serializable {
	...
	/** default constructor */
	public MstCheckexerecordInfo() {
	}

	/** minimal constructor */
	public MstCheckexerecordInfo(String recordkey) {
		this.recordkey = recordkey;
	}

	/** full constructor */
	public MstCheckexerecordInfo(String recordkey, String visitkey, String productkey, String checkkey, String checktype, String acresult, String iscom, String cstatuskey, String isauto,
