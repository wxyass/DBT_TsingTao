...
import et.tsingtaopad.db.dao.impl.MitValchecktypeMTempDaoImpl;
import et.tsingtaopad.db.dao.impl.MitValpromotionsMDaoImpl;
 ...
 */
//MIT_VALTER_M(追溯主表)
@DatabaseTable(tableName = "MIT_VALCHECKTYPE_M_TEMP", daoClass = MitValchecktypeMTempDaoImpl.class)
public class MitValchecktypeMTemp implements java.io.Serializable {
