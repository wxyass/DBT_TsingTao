...
/**
 * MstAgencysupplyInfoTemp entity. @author MyEclipse Persistence Tools
 */
//MST_AGENCYSUPPLY_INFO_TEMP(经销商供货关系信息表 临时表)
@DatabaseTable(tableName = "MST_AGENCYSUPPLY_INFO_TEMP")
public class MstAgencysupplyInfoTemp implements java.io.Serializable {
	...
	/** default constructor */
	public MstAgencysupplyInfoTemp() {
	}

	/** minimal constructor */
	public MstAgencysupplyInfoTemp(String asupplykey) {
		this.asupplykey = asupplykey;
	}

	/** full constructor */
	public MstAgencysupplyInfoTemp(String asupplykey, String status, String inprice, String reprice, String productkey, String lowerkey,
