...
/**
 * MstCollectionexerecordInfoTemp entity. @author MyEclipse Persistence Tools
 */

@DatabaseTable(tableName = "MST_COLLECTIONEXERECORD_INFO_TEMP")
public class MstCollectionexerecordInfoTemp implements java.io.Serializable {
	...
	/** default constructor */
	public MstCollectionexerecordInfoTemp() {
	}

	/** minimal constructor */
	public MstCollectionexerecordInfoTemp(String colrecordkey) {
