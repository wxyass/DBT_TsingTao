...
import et.tsingtaopad.db.dao.impl.MitVistproductInfoDaoImpl;
import et.tsingtaopad.db.dao.impl.MstVistproductInfoTempDaoImpl;


/**
 * MstVistproductInfoTemp entity. @author MyEclipse Persistence Tools
 */
//MST_VISTPRODUCT_INFO_TEMP(拜访产品-竞品我品记录表 临时表)
@DatabaseTable(tableName = "MIT_VISTPRODUCT_INFO", daoClass=MitVistproductInfoDaoImpl.class)
public class MitVistproductInfo implements java.io.Serializable {
	...
	/** default constructor */
	public MitVistproductInfo() {
	}

	/** minimal constructor */
	public MitVistproductInfo(String recordkey) {
		this.recordkey = recordkey;
	}

	/** full constructor */
	public MitVistproductInfo(String recordkey, String visitkey, String productkey, String cmpproductkey, String cmpcomkey, String agencykey,
