...
@DatabaseTable(tableName = "MST_VISTPRODUCT_INFO_TEMP", daoClass=MstVistproductInfoTempDaoImpl.class)
public class MstVistproductInfoTemp implements java.io.Serializable {
	...
	/** default constructor */
	public MstVistproductInfoTemp() {
	}

	/** minimal constructor */
	public MstVistproductInfoTemp(String recordkey) {
		this.recordkey = recordkey;
	}

	/** full constructor */
	public MstVistproductInfoTemp(String recordkey, String visitkey, String productkey, String cmpproductkey, String cmpcomkey, String agencykey,
