 ...
 * 用于指标结果计算的临时表
 */
@DatabaseTable(tableName = "MIT_CHECKEXERECORD_INFO")
public class MitCheckexerecordInfo implements java.io.Serializable {
	...
	/** default constructor */
	public MitCheckexerecordInfo() {
	}

	/** minimal constructor */
	public MitCheckexerecordInfo(String recordkey) {
		this.recordkey = recordkey;
	}

	/** full constructor */
	public MitCheckexerecordInfo(String recordkey, String visitkey, String productkey, String checkkey, String checktype, String acresult, String iscom, String cstatuskey, String isauto,
