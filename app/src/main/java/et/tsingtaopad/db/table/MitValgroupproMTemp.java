...
import et.tsingtaopad.db.dao.impl.MitValgroupproMTempDaoImpl;
 ...
 */
@DatabaseTable(tableName = "MIT_VALGROUPPRO_M_TEMP", daoClass = MitValgroupproMTempDaoImpl.class)
public class MitValgroupproMTemp implements java.io.Serializable {
