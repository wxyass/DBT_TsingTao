...
import et.tsingtaopad.db.dao.impl.MitValcmpotherMTempDaoImpl;
 ...
 */
@DatabaseTable(tableName = "MIT_VALCMPOTHER_M_TEMP", daoClass = MitValcmpotherMTempDaoImpl.class)
public class MitValcmpotherMTemp implements java.io.Serializable {
