 ...
 */
public class ZsCaculateItemAdapter extends BaseAdapter implements OnClickListener {
...
//    private TextView proTv;
     ...
     */
    public ZsCaculateItemAdapter(Activity context, List<XtProIndexValue> dataLst, List<KvStc> indexValuelst, List<XtProItem> proItemLst, String IndexId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_zdzs_checkindex_index_t, null);
            holder.proTv = (TextView)convertView.findViewById(R.id.item_zs_checkindex_proname);
            ...
            holder.indexValueTv = (TextView)convertView.findViewById(R.id.item_zs_checkindex_indexvalue);
            //holder.calculateBt = (Button)convertView.findViewById(R.id.caculate_bt_caculate);

            holder.statueTv = (TextView)convertView.findViewById(R.id.item_zs_checkindex_t_tv_statue);// 未稽查tv
            holder.statueRl = (RelativeLayout)convertView.findViewById(R.id.item_zs_checkindex_t_rl_statue);// 未稽查Rl
