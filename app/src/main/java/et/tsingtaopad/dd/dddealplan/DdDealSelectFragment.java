...
public class DdDealSelectFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    //
    public static final int SELECT_UP_SUC = 33000001;
    //
    public static final int SELECT_UP_FAIL = 33000002;
    ...
    public static class MyHandler extends Handler {
        ...
        // 软引用
        SoftReference<DdDealSelectFragment> fragmentRef;

        public MyHandler(DdDealSelectFragment fragment) {
            fragmentRef = new SoftReference<DdDealSelectFragment>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            DdDealSelectFragment fragment = fragmentRef.get();
            if (fragment == null) {
                return;
            }
