 ...
 * 功能描述:系统管理首页</br>
 */
public class SystemCoreFragment extends BaseBottomCoreFragment {

    public static final String TAG = "SystemCoreFragment";
    private GridView platform_gv_system;
    private ArrayList<Integer> images;

    public SystemCoreFragment() {
        // Required empty public constructor
    }

    public static SystemCoreFragment newInstance() {

        Bundle args = new Bundle();

        SystemCoreFragment fragment = new SystemCoreFragment();
    ...
    private void initView(View view) {
        ...
        platform_gv_system = (GridView) view.findViewById(R.id.platform_gv_system);
        // 初始化按钮对应图片
        initAuthority();
    }
    ...
    private void initData() {
        ...
        if (xtgl != null && xtgl.length() > 0) {
            ...
            platform_gv_system.setSelector(new ColorDrawable(Color.TRANSPARENT));
            platform_gv_system.setAdapter(jieMianAdapter);
            // 设置item的点击监听
            platform_gv_system.setOnItemClickListener(new ItemClickListener(this,images));
        }
    }
}
