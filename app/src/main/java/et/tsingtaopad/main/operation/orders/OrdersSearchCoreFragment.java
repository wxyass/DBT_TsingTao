package et.tsingtaopad.main.operation.orders;
...
import et.tsingtaopad.main.operation.orders.domain.OrdersDataStcN;
import et.tsingtaopad.main.operation.orders.vhtable.VHTableView;
...
public class OrdersSearchCoreFragment extends BaseCoreFragment implements View.OnClickListener {

    public static final String TAG = "OrdersSearchCoreFragment";
    ...
    public OrdersSearchCoreFragment() {
    }

    public static OrdersSearchCoreFragment newInstance() {
        DbtLog.logUtils(TAG, "newInstance()");
        OrdersSearchCoreFragment fragment = new OrdersSearchCoreFragment();
        return fragment;
    }

    public static OrdersSearchCoreFragment newInstance(Bundle args) {
    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText(R.string.operation_orders);
    ...
    public void getDataFromNet(){
        ...
        httpUtil.send("opt_get_order", buffer.toString(), new RequestCallBack<String>() {
            ...
            public void onFailure(HttpException error, String errMsg) {
                ...
                Toast.makeText(getActivity(), "网络异常 获取订单明细失败", 0).show();
            }
        });*/
    }
    ...
    public void setTableData(int index, ArrayList<String> titleAll) {
        if (0 == index) {// 0:标题栏默认3列(样式一)
            ...
            if(orderDataStcs.size()>0){// 订单数量大于0,展示数据
                ...
                Toast.makeText(getActivity(), "今日拜访未填写订单数据", 0).show();
            }
