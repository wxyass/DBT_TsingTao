...
public class CaculateAdapter extends BaseAdapter {
     ...
     */
    public CaculateAdapter(Context context, List<ProIndex> dataLst, List<KvStc> indexValuelst, List<ProItem> itemLst) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.checkindex_caculate_lvitem_o, null);
