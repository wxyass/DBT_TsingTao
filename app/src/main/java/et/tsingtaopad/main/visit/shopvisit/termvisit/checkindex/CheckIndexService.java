...
public class CheckIndexService extends ShopVisitService {
     ...
     */
    public void savePromotion(String visitId, String termId,List<CheckIndexPromotionStc> promotionLst) {
    ...
    // 保存单条促销活动
    public void saveOnePromotion(String visitId, String termId,CheckIndexPromotionStc item) {
	 ...
	 * @param vo
	 */
	public void saveMstGroupproductM(MstGroupproductMTemp vo) {
