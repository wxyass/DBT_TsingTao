package et.tsingtaopad.main.visit.shopvisit.termvisit.invoicing.adapter;
...
public class InvoicingProductAdapter extends BaseAdapter {
     ...
     */
    public InvoicingProductAdapter(Activity context, List dataLst, String[] fieldName, int[] backGroundId) {
