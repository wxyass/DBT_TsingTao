...
import et.tsingtaopad.main.visit.shopvisit.termindex.domain.TermIndexStc;
...
public class TermIndexService {
     ...
     * @return
     */
    public List<TermIndexStc> queryTermIndex(String visitId, String uploadFlag, String termId, String channelId) {
     ...
     */
    public Map<String, List<TermIndexStc>> distinctByProduct(List<TermIndexStc> termIndexLst) {

        // 要返的数据实例 
        Map<String, List<TermIndexStc>> indexMap = new HashMap<String, List<TermIndexStc>>();
     ...
     * 初始化指标状态查看页面要显示的数据结构
     *
     * @param //termindeLst 终端指标状态数据集合
     * @return Key: indexKey + indexValueKey + proKey, value:对应的指标状态数据
     */
    public Map<String, List<TermIndexStc>> initTermIndex(List<TermIndexStc> termindexLst) {
