...
//    private TextView proTv;
     ...
     * @param proItemLst       当前(可能是所有产品)产品下对应的采集项
     * @param IndexId       当前指标默认值
     */
    public CaculateItemAdapter(Context context, List<ProIndexValue> dataLst, List<KvStc> indexValuelst, List<ProItem> proItemLst, String IndexId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.checkindex_caculate_lvitem_t, null);
            holder.proTv = (TextView)convertView.findViewById(R.id.caculate_tv_proname);// 产品名称
            ...
            holder.calculateBt = (Button)convertView.findViewById(R.id.caculate_bt_caculate);// 按钮
        ...
        if (ConstValues.FLAG_1.equals(item.getIndexType())) {
            ...
            for (KvStc kvItem : indexValuelst) {
                ...
                if (!isExist) {
                    ...
                    rb.setTextColor(context.getResources().getColor(R.color.listview_item_font_color));
                    rb.setTextSize(17);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.caculate_bt_indexvalue) {//单选弹出框
            ...
            if ("ad3030fb-e42e-47f8-a3ec-4229089aab5d".equals(IndexId)) {// 铺货状态
                ...
                View itemForm = LayoutInflater.from(context).inflate(R.layout.checkindex_calculate_puhuo, null);
                ...
                View itemForm = LayoutInflater.from(context).inflate(R.layout.checkindex_calculatedialog, null);
