...
public class VieSourceAdapter extends BaseAdapter 
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (position > -1) {
            ...
            int i = et.getId();
            if (i == R.id.viesource_et_channelprice) {// 进店价 判断小数点
            	/*if(".".equals(content)){//
            ...
            } else if (i == R.id.viesource_et_sellprice) {// 零售价 判断小数点
            	/*if(".".equals(content)){//
            ...
            } else if (i == R.id.viesource_et_agency) {
