...
public class KeyiCopyDeFragment extends BaseFragmentSupport implements View.OnClickListener {
    ...
    public static class MyHandler extends Handler {
        ...
        // 软引用
        SoftReference<KeyiCopyDeFragment> fragmentRef;

        public MyHandler(KeyiCopyDeFragment fragment) {
            fragmentRef = new SoftReference<KeyiCopyDeFragment>(fragment);
        }

        @Override
        public void handleMessage(Message msg) {
            KeyiCopyDeFragment fragment = fragmentRef.get();
            if (fragment == null) {
                return;
            }
